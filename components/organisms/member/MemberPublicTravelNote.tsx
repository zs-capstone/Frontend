...
import { fetchMemberPublicTravelNote } from "../../../apis/note";
...
const MemberPublicTravelNote: React.FC<{ memberId: number }> = (props) => {
  const { memberId } = props;

  const { data, fetchNextPage, hasNextPage } =
    useInfiniteQuery<ITravelNoteProfileListType>(
      [queryKeys.memberPublicTravelNote, memberId],
      ({ pageParam = 1 }) =>
        fetchMemberPublicTravelNote(memberId, pageParam, 12),
      {
...
export default MemberPublicTravelNote;
