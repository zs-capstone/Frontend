...
import { fetchMemberPlaceLikedList } from "../../../apis/place";
...
const MemberPlaceLikedList: React.FC<{ memberId: number }> = (props) => {
  const { memberId } = props;

  const { data, fetchNextPage, hasNextPage } = useInfiniteQuery<IPlaceListType>(
    [queryKeys.memberPlaceLikedList, memberId],
    ({ pageParam = 1 }) => fetchMemberPlaceLikedList(memberId, pageParam, 12),
    {
...
export default MemberPlaceLikedList;
